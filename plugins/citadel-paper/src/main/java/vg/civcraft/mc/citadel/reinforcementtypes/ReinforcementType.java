...
public class ReinforcementType {
	...
	public ReinforcementType(double health, double returnChance, ItemStack item, long maturationTime, long acidTime,
			...
			Collection<Material> disallowedReinforceables, int id, String name) {
		this.health = health;
		this.name = name;
	...
	/**
	 * @return Returns the Maturation time needed until this block is mature in milliseconds
	 */
	...
	/**
	 * @return Returns the acid maturation time needed until this acid block is ready.
	 */
	...
	/**
	 * @return the time in milli seconds to "forgive" reinforcements and apply 100% return
