...
public class ChatStrings {
	...
	public final static String chatNowChattingWith = ChatColor.GREEN + "You are now chatting with <c>%s.";
	...
	public final static String chatGroupNowChattingIn = ChatColor.GREEN + "You are now chatting in group <c>%s.";

	public final static String chatGroupNoPerms = ChatColor.RED + "You don't have permission to chat in this group.";

	public final static String chatNeedToUnignore = ChatColor.YELLOW + "You need to unignore <c>%s.";

	public final static String chatPlayerNotFound = ChatColor.RED + "No player exists with that name.";

	public final static String chatNowIgnoring = ChatColor.GREEN + "You are now ignoring <c>%s";

	public final static String chatStoppedIgnoring = ChatColor.GREEN + "You stopped ignoring <c>%s.";
