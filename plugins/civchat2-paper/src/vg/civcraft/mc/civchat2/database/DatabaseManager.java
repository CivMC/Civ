	...
	public void processMercuryInfo(String[] message){
		if(message[0].equalsIgnoreCase("ignore")){
			if(message[1].equalsIgnoreCase("player")){
				addIgnoredPlayer(UUID.fromString(message[2]), UUID.fromString(message[3]));
			} else {
				addIgnoredGroup(UUID.fromString(message[2]), message[3]);
			}
		} else if(message[0].equalsIgnoreCase("unignore")){
			if(message[1].equalsIgnoreCase("player")){
				removeIgnoredPlayer(UUID.fromString(message[2]), UUID.fromString(message[3]));
			} else {
				removeIgnoredGroup(UUID.fromString(message[2]), message[3]);
			}
		}
	}
}
