...
public class DonumDAO {
     ...
     *
     * @param uuid UUID of the player of which we want the delivery inventory
     ...
     *
     * @param uuid Player for which the delivery inventory should be saved
     * @param im   DeliveryInventory to save
     */
     ...
     * @param hash Hashcode of the itemmap representing the players inventory on
     *             login
     ...
     * @param items ItemMap representing the players logout inventory
     */
     ...
     *
     * @param uuid      UUID of the player
     * @param inventory ItemMap representing the players inventory when dying
     */
     ...
     * to oldest
     *
     * @param uuid  UUID of the player of which we want the death inventories
     * @param limit How many inventories to load
