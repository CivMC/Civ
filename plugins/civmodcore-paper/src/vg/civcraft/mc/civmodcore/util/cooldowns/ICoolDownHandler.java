...
/**
 * Allows keeping track of one specific cooldown for any amount of objects of
 * the same type. Common examples would be cooldown for players by their UUIDs
 * 
 * @author Maxopoly
 *
 * @param <E>
...
public interface ICoolDownHandler<E> {
	...
	/**
	 * Gets the remaining cooldown of the given item. The actual meaning of this
	 * number depends on the implementation, but may never be less than 0 and
	 * never higher than the predefined maximum cooldown
	 * 
	 * @param e
	...
	/**
	 * Gives the total cooldown set for this instance. Again the actual meaning
	 * of this value depends on the implementation
	 * 
