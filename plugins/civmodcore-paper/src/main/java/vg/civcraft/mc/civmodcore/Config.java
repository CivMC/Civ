...
public class Config {
	...
	private Map<String, ConfigOption> dynamicOptions_ = new TreeMap<>();
...
//            plugin_.info("adding: "+drone.toString());
			...
			// We want to ignore any errors found from this because it could be a soft dependency that is not loaded
			// for a plugin.
		} catch (Exception ex) {
