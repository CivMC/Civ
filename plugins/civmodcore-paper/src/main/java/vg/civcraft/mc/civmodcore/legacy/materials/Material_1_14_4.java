...
/**
 * This class is intended to aid with graceful migration from 1.14.4 to newer versions.
 */
public enum Material_1_14_4 implements IMaterial {
    ...
    Material_1_14_4(int id) {
        this(id, false);
    }

    Material_1_14_4(int id, boolean legacy) {
        this.id = id;
        this.legacy = legacy;
    }
    ...
    public static Material_1_14_4 getMaterial(String slug) {
    ...
    /**
     * Migrates a 1.13 Material to 1.14
     *
     * @param legacy The 1.13 material to migrate.
     * @return Returns the migrated 1.13 material if the appropriate match exists.
     */
    public static Material_1_14_4 fromLegacy(Material_1_13_2 legacy) {
        if (legacy == null) {
            return null;
        }
        switch (legacy) {
