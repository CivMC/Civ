...
public final class RecipeAPI {
	 ...
	 *
	 * @apiNote This matcher pretty much assumes that all recipes are keyed. If other kinds of recipes come up that
	 ...
	 *
	 * @apiNote This is to prevent thrown exceptions for re-registered recipes. Since registrations often happen within
	 *     a plugin's onEnable() method, an exception here will actually disable the plugin entirely, which is a bit
