...
/**
 * This class is intended to aid with graceful migration from 1.12.2 to newer versions.
 */
public enum Material_1_12_2 implements IMaterial {
    ...
    Material_1_12_2(int id) {
        this(id, false);
    }

    Material_1_12_2(int id, boolean hasDiscriminator) {
        this.id = id;
    ...
    public static Material_1_12_2 getMaterial(int id) {
    ...
    public static Material_1_12_2 getMaterial(String slug) {
        try {
            return valueOf(slug.toUpperCase(Locale.ENGLISH));
        }
        catch (Exception ignored) {
            return null;
        }
