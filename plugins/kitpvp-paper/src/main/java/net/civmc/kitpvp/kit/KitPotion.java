...
public enum KitPotion {
    ...
    SLOWNESS(PotionType.SLOWNESS, 0),
    LONG_SLOWNESS(PotionType.LONG_SLOWNESS, 0),
    STRONG_SLOWNESS(PotionType.STRONG_SLOWNESS, 0),
    ...
    HARMING(PotionType.HARMING, 0),
    STRONG_HARMING(PotionType.STRONG_HARMING, 0),
    POISON(PotionType.POISON, 0),
    LONG_POISON(PotionType.LONG_POISON, 0),
    STRONG_POISON(PotionType.STRONG_POISON, 0),
    ...
    WEAKNESS(PotionType.WEAKNESS, 0),
    LONG_WEAKNESS(PotionType.LONG_WEAKNESS, 0),
