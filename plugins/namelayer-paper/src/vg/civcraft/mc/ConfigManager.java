...
public class ConfigManager {
	...
	public static int getAutoFlush(){
		return config.getInt("groups.database.autoflush");
	}
	
	public static int getMaxFlushCount(){
		return config.getInt("config.database.maxflushcount");
	}
}
