...
public class Gearblock {
    ...
    public GearblockLink getLink() {
        return _link != null && !_link.isBroken() ? _link : null;
    }

    public GearblockLink getBrokenLink() {
        return _link != null && _link.isBroken() ? _link : null;
    }

    public void setLink(GearblockLink link) {
        _link = link;
    }
    ...
    public TimerOperation getTimerOperation() {
        return _timerOperation;
    }
    ...
    public TimerBatch getTimerBatch() {
        return _timerBatch;
    }

    public void setTimerBatch(TimerBatch timerBatch) {
        _timerBatch = timerBatch;
    }

    public long getLastSwitchTime() {
        return _lastSwitchTime;
    }

    public void setLastSwitchTime() {
        _lastSwitchTime = System.currentTimeMillis();
    }

    public void setLockGearblock(Gearblock lockGearblock) {
        _lockGearblock = lockGearblock;
    }

    public Gearblock getLockGearblock() {
        return _lockGearblock;
    }

    public void setLockedGearblocks(List<Gearblock> lockedGearblocks) {
        _lockedGearblocks = lockedGearblocks;
    }

    public List<Gearblock> getLockedGearblocks() {
        return _lockedGearblocks;
    }
