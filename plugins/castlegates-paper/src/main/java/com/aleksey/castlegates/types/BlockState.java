...
public class BlockState {
    ...
    public int getBlockDataLen() {
        return _blockData.length() + 1;
    }

    private ReinforcementInfo _reinforcement;

    public void setReinforcement(ReinforcementInfo reinforcement) {
        _reinforcement = reinforcement;
    }

    public ReinforcementInfo getReinforcement() {
