...
import com.untamedears.JukeAlert.commands.ClearCommand;
...
public class SnitchLogGUI {
	...
	private List<IClickable> constructContent() {
		...
		for (SnitchAction action : actions) {
			...
			case BLOCK_BREAK:
				...
				ISUtils.setName(is,
						ChatColor.GOLD + action.getMaterial().toString() + " broken by " + action.getInitiateUser());
				break;
			case BLOCK_BURN:
				is = new ItemStack(action.getMaterial());
			...
			case BLOCK_PLACE:
				is = new ItemStack(action.getMaterial());
				ISUtils.setName(is,
						ChatColor.GOLD + action.getMaterial().toString() + " placed by " + action.getInitiateUser());
				break;
			case BLOCK_USED:
				is = new ItemStack(action.getMaterial());
				ISUtils.setName(is,
			...
			case ENTITY_MOUNT:
				...
				ISUtils.setName(is,
						ChatColor.GOLD + action.getVictim() + " " + horseAction + " by " + action.getInitiateUser());
				break;
			case ENTRY:
			...
			case IGNITED:
				...
				ISUtils.setName(is,
						ChatColor.GOLD + action.getMaterial().toString() + " ignited by " + action.getInitiateUser());
				break;
			case KILL:
				...
				break;
			case LOGIN:
				is = new ItemStack(Material.ENDER_EYE);
	...
	private IClickable constructInfoStack() {
		...
		ISUtils.addLore(is,
				ChatColor.AQUA + "Located at " + snitch.getX() + ", " + snitch.getY() + ", " + snitch.getZ());
