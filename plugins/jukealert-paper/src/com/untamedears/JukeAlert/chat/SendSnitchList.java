...
public class SendSnitchList implements Runnable {
	...
	public void run() {
		if (info != null && !info.isEmpty()) {
			...
			output += ChatColor.GRAY + String.format("%s %s %s", ChatFiller.fillString("MC World", (double) 15), ChatFiller.fillString("Location", (double) 16), ChatFiller.fillString("Hours to Cull", (double) 22)) + "Group\n";
