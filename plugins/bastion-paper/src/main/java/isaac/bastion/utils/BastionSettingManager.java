...
public class BastionSettingManager {
    ...
    private void initSettings() {
        ...
        bsiLocation = new DisplayLocationSetting(Bastion.getPlugin(), DisplayLocationSetting.DisplayLocation.ACTIONBAR, "BSI Location", "bsiLocation", new ItemStack(Material.ARROW), "BSI");
