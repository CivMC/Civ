...
public class BlockRestrictionHandler {
	...
	public BlockRestrictionHandler(boolean enabled, RestrictionMode mode, List<Material> blacklist, List<Material> whitelist, Map<Material, CooldownHandler> materialCooldownHandlers) {
