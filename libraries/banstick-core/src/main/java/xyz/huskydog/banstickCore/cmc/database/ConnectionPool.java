...
public class ConnectionPool {
    ...
    public ConnectionPool(@NotNull final DatabaseCredentials credentials) {
        var plugin = BanstickCore.getInstance();
        if (plugin == null) {
            throw new IllegalStateException("BanstickCore instance is not initialized.");
        }
        ...
        try (final Connection connection = getConnection();
            ...
            this.logger.error("Unable to connect to the database", exception);
